...
network.initialize_persistant_particles()

n_train = int(60000/batch_size)
n_test = int(10000/batch_size)
dataset = MNIST_Wrapper(batch_size, device, n_train=60000)
...
training_error = 1-(float(training_error)/60000)
test_error = 0
...
for epoch in range(1,num_epochs+1):
    ...
    print('Epoch {} complete.\n  Training error: {}\n  Test error: {}'\
          .format(epoch, 1-(float(training_error)/60000),1-(float(test_error)/10000)))